...
function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A network monitoring tool using Python where users can ping sites, check on their DNS, find the traceroute, and monitor the I/O of the network.",
      image: logo,
    ...
    },
    {
      ...
      description:
        "An e-commerce-based web application for a bookstore where users can add, update or remove their books",
      image: logo,
